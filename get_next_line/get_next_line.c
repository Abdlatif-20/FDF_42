...
/*   Updated: 2023/02/15 02:07:22 by aben-nei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	tmp = string;
	line = ft_substr1(string, 0, i2 + 1);
	string = ft_substr1(string, i2 + 1, (i1 - i2));
	free(tmp);
	return (line);
}
